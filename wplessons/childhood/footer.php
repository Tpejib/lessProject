<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="141" title="Форма модалка"]'); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="https://<?php the_field('instagram', 2); ?>" class="footer__social-item" target="_blank">
                            ...
                            <a href="https://<?php the_field('facebook', 2); ?>" class="footer__social-item" target="_blank">
                            ...
                            <a href="https://<?php the_field('youtube', 2); ?>" class="footer__social-item" target="_blank">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCNK7XhyCp_0yaltlxLuScKdAOHag0Lf24"></script>
