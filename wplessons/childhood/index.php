                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="title contacts__minititle">Оставьте ваш отзыв</div>
                            ...
                            <?php echo do_shortcode( '[contact-form-7 id="140" title="Форма отзывов"]' ) ?>
                            </div>
                    </div>
                </div>
                <div class="row mt70">
